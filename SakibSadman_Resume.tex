...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{\textbf{Developed} a web application for \textbf{parking space management and booking}, featuring \textbf{user authentication}, \textbf{profile management}, and \textbf{real-time search and booking} capabilities.}
    \resumeItemListEnd

  \resumeProjectHeading
    {\textbf{\href{https://github.com/badhon495/Easy_Docker_Installation}{Easy Docker Installation}} $|$ \emph{Bash (Shell Script)}}{2024}
    \resumeItemListStart
      \resumeItem{\textbf{Automated} Docker installation for major \textbf{Linux distributions} (Ubuntu, Debian, CentOS, Fedora), \textbf{streamlining system setup} and reducing manual configuration.}
    \resumeItemListEnd
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
    \resumeItem{\textbf{Built} a \textbf{full-stack emergency response platform} with \textbf{live chat}, \textbf{complaint management}, \textbf{file uploads}, \textbf{real-time location sharing}, and \textbf{role-based access control} for users and responders.}
    \resumeItemListEnd
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{\textbf{Created} a web-based tool using \textbf{JavaScript and Regex} to \textbf{analyze academic grade sheets}, allowing users to \textbf{simulate grade changes} and \textbf{calculate required grades} to reach target CGPA.}
    \resumeItemListEnd  
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{\textbf{Developed} a \textbf{machine learning-powered} web application for \textbf{real-time network intrusion detection} using Streamlit and \textbf{Random Forest classifier} with user-friendly interface and visual results.}
    \resumeItemListEnd
...
\resumeItemListStart
\resumeItem{\textbf{Contributed} to \href{https://opentelemetry.io/}{OpenTelemetry} by \textbf{localizing documentation} into \textbf{Bangla}, \textbf{collaborating with global maintainers}, and gaining hands-on experience in \textbf{open-source workflows}, \textbf{CI/CD pipelines}, and \textbf{documentation standards}.}
\resumeItemListEnd
