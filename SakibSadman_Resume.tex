...
\resumeSubheading
{Bachelor of Science in Computer Science}{CGPA 3.67/4.00}
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    {\textbf{\href{https://github.com/nihal-kabir/ShikkhaDwar}{ShikkhaDwar}} $|$ \emph{Flask, SQLAlchemy, PostgreSQL, Bootstrap, JavaScript} $|$ \textbf{\href{https://shikkhadwar-81r2.onrender.com/}{Live}}}{2025}
    \resumeItemListStart
...
\section{Skills}
 ...
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Language}{: HTML, CSS, JavaScript, PHP, Laravel, Spring Boot, React, PostgreSQL, MySQL, Python, Bash} \\
    }}
 \end{itemize}
